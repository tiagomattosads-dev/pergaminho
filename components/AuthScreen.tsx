...
const AuthScreen: React.FC<Props> = ({ onLogin, theme }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 overflow-hidden relative selection:bg-[#d4af37]/40">
      ...
      >
        <source src="https://res.cloudinary.com/dutufef4s/video/upload/v1770325164/2970d572d03a4160ac6d731f004e9275_luts5h.mp4" type="video/mp4" />
      </video>
      ...
      <div className={`relative z-10 w-full max-w-md transition-all duration-700 transform ${focusedField ? 'scale-[1.01]' : 'scale-100'}`}>
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-6 relative z-10">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className={`absolute left-4 top-1/2 -translate-y-1/2 transition-all duration-300 z-10 ${focusedField === 'email' ? 'text-[#d4af37] scale-110' : 'text-gray-400 opacity-40'}`}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className={`absolute left-4 top-1/2 -translate-y-1/2 transition-all duration-300 z-10 ${focusedField === 'password' ? 'text-[#d4af37] scale-110' : 'text-gray-400 opacity-40'}`}>
